...
const validarInputs = (e) => {
	switch (e.target.name) {
		...
		break;
		case "cantidadLibro":
			validarCampo(expresiones.numeros, e.target, 'cantidadLibro','Solo se admiten números');
		break;
...
function validarFormulario() {
    if(campos.codigoLibro && campos.isbnLibro && campos.tituloLibro && campos.autorLibro && campos.cantidadLibro && campos.valorPrestamoLibro){
